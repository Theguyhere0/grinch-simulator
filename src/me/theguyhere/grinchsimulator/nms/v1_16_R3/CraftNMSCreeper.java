...
public class CraftNMSCreeper extends CraftCreeper {

    public CraftNMSCreeper(CraftServer server, EntityNMSCreeper entity) {
        super(server, entity);
    ...
    @Override public int getMaxFuseTicks() {
        return 0;
    }
    @Override public void setFuseTicks(int ticks) { }
    @Override public int getFuseTicks() {
        return 0;
    }
    @Override public int getExplosionRadius() {
        return 0;
    }
